...
const Login: React.FC = () => {
  ...
  const login = async () => {
    ...
    try {
      const res = await axios.post(`${apiUrl}/api/${tenant}/login`, {
        email: loginValue,
        password: passwordValue,
      });

      if (res.data.access_token) {
        localStorage.setItem("tenantToken", res.data.access_token);
  ...
  return (
    <Grid container className={classes.container}>
      <div className={classes.logotypeContainer}>
        ...
        <Typography className={classes.logotypeText}>Tenant Login - {tenant}</Typography>
      </div>
